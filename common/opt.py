...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--num_coeff_Time_kept', default=3, type=int) 
        self.parser.add_argument('--model_downsample_rate', default=8, type=int)    
        ...
        self.parser.add_argument('--root_path', type=str, default='/mnt/e9933268-1ca5-423d-88b2-ec7b2e67a577/Coding/C-FTS/dataset/')
        ...
        self.parser.add_argument('-c','--checkpoint', type=str, default='human3.6M-model')
