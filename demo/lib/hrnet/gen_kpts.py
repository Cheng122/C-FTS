...
cfg_dir = '/mnt/e9933268-1ca5-423d-88b2-ec7b2e67a577/Coding/STCFormer-main/demo/lib/hrnet/experiments/'
model_dir = '/mnt/e9933268-1ca5-423d-88b2-ec7b2e67a577/Coding/STCFormer-main/demo/lib/checkpoint/'
...
def gen_video_kpts(video, det_dim=416, num_peroson=1, gen_output=False):
    ...
    args = parse_args()
    reset_config(args)                                                  # args变量作为参数传递给reset_config()函数，以便使用新的配置重置程序的配置
