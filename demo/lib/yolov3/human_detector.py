...
def arg_parse():
    ...
    parser.add_argument('-wf', '--weight-file', type=str, default= '/mnt/e9933268-1ca5-423d-88b2-ec7b2e67a577/Coding/STCFormer-main/demo/lib/checkpoint/yolov3.weights', help='The path'
